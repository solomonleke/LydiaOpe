...
import { Church, PartyPopper, Clock, MapPin, ExternalLink, CalendarPlus, Sparkles } from 'lucide-react';
import { EVENTS } from '../data/weddingData';

export const ScheduleSection: React.FC = () => {
  const downloadIcs = (title: string, venue: string, addr: string) => {
    ...
    <section id="schedule" className="section">
      <div className="container">
        <div className="section-header">
          <div className="label"><Sparkles size={14} /> Order of Events <Sparkles size={14} /></div>
          <h2 className="heading-lg">Events & Schedule</h2>
          <p className="body-text">Join us on Saturday, 10th October 2026 as we celebrate our union in Enugu.</p>
              ...
              <div className="card-body" style={{ padding: 28 }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 16 }}>
                  <div className="schedule-icon">
                    {evt.icon === 'Church' ? <Church size={24} /> : <PartyPopper size={24} />}
                  </div>
                ...
                <div className="schedule-venue">
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 6, paddingLeft: 26, marginTop: 6, fontSize: '0.78rem', color: 'var(--text-muted)' }}>
                    <Clock size={14} /> Doors open 30 minutes prior
                  </div>
                </div>
                ...
                <div className="schedule-actions">
                  ...
                  <button onClick={() => downloadIcs(evt.title, evt.venue, evt.address)} className="btn btn-ghost btn-sm">
